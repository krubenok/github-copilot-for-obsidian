...
export class MockSetting {
  ...
  addText(callback: (text: { setValue: (value: string) => unknown; onChange: (cb: () => void) => unknown; }) => void): this {
    const component = {
      setValue: () => component,
      onChange: () => component,
    };
  ...
  addToggle(callback: (toggle: { setValue: (value: boolean) => unknown; onChange: (cb: () => void) => unknown; }) => void): this {
    const component = {
      setValue: () => component,
      onChange: () => component,
    };
  ...
  addButton(callback: (button: { setButtonText: (value: string) => unknown; onClick: (cb: () => void) => unknown; setDisabled: (value: boolean) => unknown; }) => void): this {
    const component = {
